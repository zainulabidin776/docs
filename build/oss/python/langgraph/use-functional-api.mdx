...
import LanggraphFunctionalApiStreamCustomDataPy from '/snippets/python/code-samples/langgraph-functional-api-stream-custom-data-py.mdx';
import LanggraphFunctionalApiStreamCustomDataJs from '/snippets/python/code-samples/langgraph-functional-api-stream-custom-data-js.mdx';
