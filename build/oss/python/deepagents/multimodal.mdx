...
import MultimodalSummarizationPy from '/snippets/python/code-samples/multimodal-summarization-py.mdx';
import MultimodalSummarizationJs from '/snippets/python/code-samples/multimodal-summarization-js.mdx';
import MultimodalUserInputPy from '/snippets/python/code-samples/multimodal-user-input-py.mdx';
import MultimodalUserInputJs from '/snippets/python/code-samples/multimodal-user-input-js.mdx';
import MultimodalCaptureScreenshotPy from '/snippets/python/code-samples/multimodal-capture-screenshot-py.mdx';
import MultimodalCaptureScreenshotJs from '/snippets/python/code-samples/multimodal-capture-screenshot-js.mdx';
