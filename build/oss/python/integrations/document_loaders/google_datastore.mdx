...
description: Integrate with the Google firestore in datastore mode document loader
  using LangChain Python.
integration:
  name: Google firestore in datastore mode
  pypi: langchain-google-datastore
---
