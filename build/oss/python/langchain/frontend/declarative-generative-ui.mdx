...
[generative UI spectrum](/oss/python/langchain/frontend/generative-ui-overview). The agent emits a
...
[controlled generative UI](/oss/python/langchain/frontend/controlled-generative-ui). When
...
wire CopilotKit to a LangGraph deployment, see [CopilotKit](/oss/python/langchain/frontend/integrations/copilotkit).
